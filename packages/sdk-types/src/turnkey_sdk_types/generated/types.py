...
class v1UpdateAuthProxyConfigIntent(TurnkeyBaseModel):
    ...
    otpLength: Optional[int] = Field(
        default=None, description="Desired OTP code length (6–9)."
    )
    sendFromEmailSenderName: Optional[str] = Field(
...
class TGetActivitiesBody(TurnkeyBaseModel):
    ...
    filterByStatus: List[v1ActivityStatus]
    ...
    filterByType: List[v1ActivityType]
...
class TCreateApiKeysResponse(TurnkeyBaseModel):
    activity: v1Activity
    apiKeyIds: Optional[List[str]] = Field(
        default=None, description="A list of API Key IDs."
    )
...
class TCreateApiOnlyUsersResponse(TurnkeyBaseModel):
    ...
    userIds: Optional[List[str]] = Field(
        default=None, description="A list of API-only User IDs."
    )
...
class TCreateAuthenticatorsResponse(TurnkeyBaseModel):
    activity: v1Activity
    authenticatorIds: Optional[List[str]] = Field(
        default=None, description="A list of Authenticator IDs."
    )
...
class TCreateFiatOnRampCredentialResponse(TurnkeyBaseModel):
    activity: v1Activity
    fiatOnRampCredentialId: Optional[str] = Field(
        default=None,
        description="Unique identifier of the Fiat On-Ramp credential that was created",
    )
...
class TCreateInvitationsResponse(TurnkeyBaseModel):
    activity: v1Activity
    invitationIds: Optional[List[str]] = Field(
        default=None, description="A list of Invitation IDs"
    )
...
class TCreateOauth2CredentialResponse(TurnkeyBaseModel):
    activity: v1Activity
    oauth2CredentialId: Optional[str] = Field(
        default=None,
        description="Unique identifier of the OAuth 2.0 credential that was created",
    )
...
class TCreateOauthProvidersResponse(TurnkeyBaseModel):
    activity: v1Activity
    providerIds: Optional[List[str]] = Field(
        default=None, description="A list of unique identifiers for Oauth Providers"
    )
...
class TCreatePolicyResponse(TurnkeyBaseModel):
    ...
    policyId: Optional[str] = Field(
        default=None, description="Unique identifier for a given Policy."
    )
...
class TCreatePrivateKeyTagResponse(TurnkeyBaseModel):
    activity: v1Activity
    privateKeyTagId: Optional[str] = Field(
        default=None, description="Unique identifier for a given Private Key Tag."
    )
    privateKeyIds: Optional[List[str]] = Field(
        default=None, description="A list of Private Key IDs."
    )
...
class TCreatePrivateKeysResponse(TurnkeyBaseModel):
    activity: v1Activity
    privateKeys: Optional[List[v1PrivateKeyResult]] = Field(
        default=None, description="A list of Private Key IDs and addresses."
    )
...
class TCreateReadOnlySessionResponse(TurnkeyBaseModel):
    ...
    organizationName: Optional[str] = Field(
        default=None, description="Human-readable name for an Organization."
    )
    userId: Optional[str] = Field(
        default=None, description="Unique identifier for a given User."
    )
    ...
    session: Optional[str] = Field(
        default=None, description="String representing a read only session"
    )
    sessionExpiry: Optional[str] = Field(
        default=None,
        description="UTC timestamp in seconds representing the expiry time for the read only session.",
    )
...
class TCreateSmartContractInterfaceResponse(TurnkeyBaseModel):
    activity: v1Activity
    smartContractInterfaceId: Optional[str] = Field(
        default=None, description="The ID of the created Smart Contract Interface."
    )
...
class TCreateSubOrganizationResponse(TurnkeyBaseModel):
    activity: v1Activity
    subOrganizationId: Optional[str] = Field(default=None)
    wallet: Optional[v1WalletResult] = Field(default=None)
    rootUserIds: Optional[List[str]] = Field(default=None)
...
class TCreateUserTagResponse(TurnkeyBaseModel):
    activity: v1Activity
    userTagId: Optional[str] = Field(
        default=None, description="Unique identifier for a given User Tag."
    )
    userIds: Optional[List[str]] = Field(
        default=None, description="A list of User IDs."
    )
...
class TCreateWalletResponse(TurnkeyBaseModel):
    activity: v1Activity
    walletId: Optional[str] = Field(
        default=None, description="Unique identifier for a Wallet."
    )
    addresses: Optional[List[str]] = Field(
        default=None, description="A list of account addresses."
    )
...
class TCreateWalletAccountsResponse(TurnkeyBaseModel):
    activity: v1Activity
    addresses: Optional[List[str]] = Field(
        default=None, description="A list of derived addresses."
    )
...
class TDeleteAuthenticatorsResponse(TurnkeyBaseModel):
    activity: v1Activity
    authenticatorIds: Optional[List[str]] = Field(
        default=None, description="Unique identifier for a given Authenticator."
    )
...
class TDeleteInvitationResponse(TurnkeyBaseModel):
    ...
    invitationId: Optional[str] = Field(
        default=None, description="Unique identifier for a given Invitation."
    )
...
class TDeletePrivateKeyTagsResponse(TurnkeyBaseModel):
    activity: v1Activity
    privateKeyTagIds: Optional[List[str]] = Field(
        default=None, description="A list of Private Key Tag IDs."
    )
    privateKeyIds: Optional[List[str]] = Field(
        default=None, description="A list of Private Key IDs."
    )
...
class TDeleteSmartContractInterfaceResponse(TurnkeyBaseModel):
    activity: v1Activity
    smartContractInterfaceId: Optional[str] = Field(
        default=None, description="The ID of the deleted Smart Contract Interface."
    )
...
class TDeleteSubOrganizationResponse(TurnkeyBaseModel):
    activity: v1Activity
    subOrganizationUuid: Optional[str] = Field(
        default=None,
        description="Unique identifier of the sub organization that was removed",
    )
...
class TDeleteUserTagsResponse(TurnkeyBaseModel):
    activity: v1Activity
    userTagIds: Optional[List[str]] = Field(
        default=None, description="A list of User Tag IDs."
    )
    userIds: Optional[List[str]] = Field(
        default=None, description="A list of User IDs."
    )
...
class TDeleteWalletAccountsResponse(TurnkeyBaseModel):
    activity: v1Activity
    walletAccountIds: Optional[List[str]] = Field(
        default=None,
        description="A list of wallet account unique identifiers that were removed",
    )
...
class TDeleteWalletsResponse(TurnkeyBaseModel):
    activity: v1Activity
    walletIds: Optional[List[str]] = Field(
        default=None,
        description="A list of wallet unique identifiers that were removed",
    )
...
class TEmailAuthResponse(TurnkeyBaseModel):
    activity: v1Activity
    userId: Optional[str] = Field(
        default=None, description="Unique identifier for the authenticating User."
    )
    apiKeyId: Optional[str] = Field(
        default=None, description="Unique identifier for the created API key."
    )
...
class TEthSendRawTransactionResponse(TurnkeyBaseModel):
    ...
    transactionHash: Optional[str] = Field(
        default=None, description="The transaction hash of the sent transaction"
    )
...
class TEthSendTransactionResponse(TurnkeyBaseModel):
    activity: v1Activity
    sendTransactionStatusId: Optional[str] = Field(
        default=None,
        description="The send_transaction_status ID associated with the transaction submission for sponsored transactions",
    )
...
class TExportPrivateKeyResponse(TurnkeyBaseModel):
    ...
    privateKeyId: Optional[str] = Field(
        default=None, description="Unique identifier for a given Private Key."
    )
    exportBundle: Optional[str] = Field(
        default=None,
        description="Export bundle containing a private key encrypted to the client's target public key.",
    )
...
class TExportWalletResponse(TurnkeyBaseModel):
    activity: v1Activity
    walletId: Optional[str] = Field(
        default=None, description="Unique identifier for a given Wallet."
    )
    exportBundle: Optional[str] = Field(
        default=None,
        description="Export bundle containing a wallet mnemonic + optional newline passphrase encrypted by the client's target public key.",
...
class TExportWalletAccountResponse(TurnkeyBaseModel):
    activity: v1Activity
    address: Optional[str] = Field(
        default=None, description="Address to identify Wallet Account."
    )
    exportBundle: Optional[str] = Field(
        default=None,
        description="Export bundle containing a private key encrypted by the client's target public key.",
...
class TImportPrivateKeyResponse(TurnkeyBaseModel):
    activity: v1Activity
    privateKeyId: Optional[str] = Field(
        default=None, description="Unique identifier for a Private Key."
    )
    addresses: Optional[List[immutableactivityv1Address]] = Field(
        default=None, description="A list of addresses."
    )
...
class TInitFiatOnRampResponse(TurnkeyBaseModel):
    activity: v1Activity
    onRampUrl: Optional[str] = Field(
        default=None, description="Unique URL for a given fiat on-ramp flow."
    )
    onRampTransactionId: Optional[str] = Field(
        default=None,
        description="Unique identifier used to retrieve transaction statuses for a given fiat on-ramp flow.",
    )
    onRampUrlSignature: Optional[str] = Field(
...
class TInitImportPrivateKeyResponse(TurnkeyBaseModel):
    activity: v1Activity
    importBundle: Optional[str] = Field(
        default=None,
        description="Import bundle containing a public key and signature to use for importing client data.",
    )
...
class TInitOtpResponse(TurnkeyBaseModel):
    activity: v1Activity
    otpId: Optional[str] = Field(
        default=None, description="Unique identifier for an OTP authentication"
    )
...
class TInitUserEmailRecoveryResponse(TurnkeyBaseModel):
    activity: v1Activity
    userId: Optional[str] = Field(
        default=None, description="Unique identifier for the user being recovered."
    )
...
class TRecoverUserResponse(TurnkeyBaseModel):
    activity: v1Activity
    authenticatorId: Optional[List[str]] = Field(
        default=None, description="ID of the authenticator created."
    )
...
class TRemoveOrganizationFeatureResponse(TurnkeyBaseModel):
    activity: v1Activity
    features: Optional[List[v1Feature]] = Field(
        default=None, description="Resulting list of organization features."
    )
...
class TSignRawPayloadResponse(TurnkeyBaseModel):
    ...
    r: Optional[str] = Field(
        default=None, description="Component of an ECSDA signature."
    )
...
class TSignTransactionResponse(TurnkeyBaseModel):
    activity: v1Activity
    signedTransaction: Optional[str] = Field(default=None)
...
class TUpdateUserResponse(TurnkeyBaseModel):
    activity: v1Activity
    userId: Optional[str] = Field(default=None, description="A User ID.")
...
class TUpdateWalletResponse(TurnkeyBaseModel):
    activity: v1Activity
    walletId: Optional[str] = Field(default=None, description="A Wallet ID.")
